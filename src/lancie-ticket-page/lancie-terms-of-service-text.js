...
Polymer({
  _template: `
    ...
    <div>
      ...
      <ul>
        <li>This service is for PCs and its necessary accessories only, meaning other objects will be rejected.</li>
        <li>The PC and accessories must be fully and neatly packed in boxes.</li>
        <li>Every box must consist of a label containing:</li>
        <ul>
          <li>The participant's full name and address</li>
          <li>The total number of boxes the participant is handing in and the current box’s number</li>
        </ul>
      </ul>
